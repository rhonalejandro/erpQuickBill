...
<head>
    ...
    @else
        <link rel="stylesheet"
            href="{{ Module::asset('LandingPage:Resources/assets/css/style.css?v=') . rand(0, 99999999) }}"
            id="main-style-link">
    @endif
    <link rel="stylesheet"
        href=" {{ Module::asset('LandingPage:Resources/assets/css/customizer.css?v=') . rand(0, 99999999) }}" />
    <link rel="stylesheet"
        href=" {{ Module::asset('LandingPage:Resources/assets/css/landing-page.css?v=') . rand(0, 99999999) }}" />
