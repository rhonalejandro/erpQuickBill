...
class UsersTableTenantSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $superAdmin = User::create(
            [
                'name' => 'Soporte Quickbill',
                'email' => 'soporte@quickbill.com',
                'password' => Hash::make('85418284Kh$'),
                'type' => 'super admin',
                'lang' => 'es',
                'avatar' => '',
                'created_by' => 0,
        ...
        Utility::chartOfAccountTypeData(2); // id tenant
        Utility::pipeline_lead_deal_Stage(2); // id tenant
        Utility::project_task_stages(2); // id tenant
        Utility::labels(2); // id tenant
        Utility::sources(2); // id tenant
        Utility::jobStage(2); // id tenant
