        ...
        <div class="container">
            <div class="card">
                <div class="card-body w-100">
                    ...
                    <form class="payment-form" method="post" action="{{ route('invoice.get.authorizenet.status') }}"
                        id="authorizenetForm">
                        @csrf
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    <label class="d-block mb-1">{{ __('Card Number') }}<sup aria-hidden="true"
                                            class="text-danger">*</sup></label>
                                    <input class="form-control" pattern="\d{16}" type="text"
