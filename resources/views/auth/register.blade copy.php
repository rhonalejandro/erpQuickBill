        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="">
                <div class="form-group mb-3">
                    <label for="subdomain" class="form-label">{{ __('Name Access System') }}</label>
                    @php
                    ...
                    <div class="input-group subdomain-input-container">
                        <input id="subdomain" type="text" class="form-control @error('subdomain') is-invalid @enderror"
                            name="subdomain" value="{{ old('subdomain') }}" required autocomplete="off" autofocus
                            placeholder="{{ __('Enter SubDomain') }}">
                        <span id="domain-suffix" class="input-group-text">.{{ $domain }}</span>
                    </div>
