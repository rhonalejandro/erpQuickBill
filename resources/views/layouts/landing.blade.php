...
@endphp
<!DOCTYPE html>
<html lang="es" dir="{{ $setting['SITE_RTL'] == 'on' ? 'rtl' : '' }}">
...
<body class="{{ $color }}">
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            ...
            <img src="{{ asset('landing/images/dashboard.png') }}" alt=""
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="{{ asset('landing/images/dashboard.png') }}" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="{{ asset('landing/images/dash-2.svg') }}" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
            <div class="row align-items-center justify-content-start">
