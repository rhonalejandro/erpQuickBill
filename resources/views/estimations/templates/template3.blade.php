<!DOCTYPE html>
<html lang="es" dir="{{ $SITE_RTL == 'on' ? 'rtl' : '' }}">
                                ...
                                <div data-v-e95a8a8c="" class="d-inner">
                                    <div data-v-e95a8a8c="" class="row">
                                        ...
                                        <div data-v-e95a8a8c="" class="col-1"><img data-v-e95a8a8c=""
                                                src="{{ $img }}" style="max-width: 150px" class="d-logo"></div>
                                    </div>
...
@endif
                                                ...
                                                <tbody data-v-e95a8a8c="">
                                                    <tr data-v-e95a8a8c="">
                                                        <td data-v-e95a8a8c="" class="tu fwb"
                                                            style="color: {{ $color == '#ffffff' ? 'black' : $color }};">
                                                            {{ __('Number') }}:</td>
                                                        <td data-v-e95a8a8c="" class="text-end">
                                                            {{ $usr->estimateNumberFormat($estimation->estimation_id) }}
                                                        </td>
                                                    </tr>
                                                    <tr data-v-e95a8a8c="">
                                                        <td data-v-e95a8a8c="" class="tu fwb"
                                                            ...
                                                            {{ __('Issue Date') }}:</td>
                                                        <td data-v-e95a8a8c="" class="text-end">
                                                            {{ $usr->dateFormat($estimation->issue_date) }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div data-v-e95a8a8c="" class="row">
                                        <div data-v-e95a8a8c="" class="col-2">
                                            <div data-v-e95a8a8c="" class="col-66"><strong data-v-e95a8a8c=""
                                                    class="tu mb5"
                                    ...
                                    <div data-v-e95a8a8c="" class="d-table">
                                        <div data-v-e95a8a8c="" class="d-table">
                                            <div data-v-e95a8a8c="" class="tu d-table-tr"
                                                ...
                                                <div data-v-e95a8a8c="" class="d-table-th w-13">
                                                    {{ __('Item description') }}</div>
                                                <div data-v-e95a8a8c="" class="d-table-th w-3">{{ __('Price') }}
                                                </div>
                                                <div data-v-e95a8a8c="" class="d-table-th w-2">{{ __('Qty') }}
                                                </div>
                                                <div data-v-e95a8a8c="" class="d-table-th w-3 text-end">
                                                    {{ __('Amount') }}</div>
                                            </div>
                                                ...
                                                @if (isset($estimation->getProducts) && count($estimation->getProducts) > 0)
                                                    @foreach ($estimation->getProducts as $key => $item)
                                                        <div data-v-e95a8a8c="" class="d-table-tr"
                                                            ...
                                                            <div data-v-e95a8a8c="" class="d-table-td w-3"><span
                                                                    data-v-e95a8a8c="">{{ $usr->priceFormat($item->pivot->price) }}</span>
                                                            </div>
                                                            <div data-v-e95a8a8c="" class="d-table-td w-2"><span
                                                                    data-v-e95a8a8c="">{{ $item->pivot->quantity }}</span>
                                                            </div>
                                                            <div data-v-e95a8a8c="" class="d-table-td w-3 text-end">
                                                                <span
                                                                    data-v-e95a8a8c="">{{ $usr->priceFormat($item->pivot->price * $item->pivot->quantity) }}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
                                                    <div data-v-e95a8a8c="" class="d-table-tr"
                                                        ...
                                                        <div data-v-e95a8a8c="" class="d-table-td w-2"><span
                                                                data-v-e95a8a8c="">-</span></div>
                                                        <div data-v-e95a8a8c="" class="d-table-td w-3 text-end"><span
                                                                data-v-e95a8a8c="">-</span></div>
                                                    </div>
                                                @endif
                                            </div>
                                                ...
                                                <div data-v-e95a8a8c="" class="d-table-summary">
                                                    <div data-v-e95a8a8c="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-e95a8a8c="" class="d-table-value">
                                                            {{ $usr->priceFormat($estimation->getSubTotal()) }}</div>
                                                    </div>
                                                    @if ($estimation->discount)
                                                        <div data-v-e95a8a8c="" class="d-table-summary-item">
                                                            <div data-v-e95a8a8c="" class="tu d-table-label">
                                                                {{ __('Discount') }}:</div>
                                                            <div data-v-e95a8a8c="" class="d-table-value">
                                                                {{ $usr->priceFormat($estimation->discount) }}</div>
                                                        </div>
                                                    @endif
                                                    @if ($estimation->getTax())
                                                        <div data-v-e95a8a8c="" class="d-table-summary-item">
                                                            <div data-v-e95a8a8c="" class="tu d-table-label">
                                                                {{ $estimation->tax->name }}
                                                                ({{ $estimation->tax->rate }}%):</div>
                                                            <div data-v-e95a8a8c="" class="d-table-value">
                                                                {{ $usr->priceFormat($estimation->getTax()) }}</div>
                                                        </div>
                                                    @endif
                                                    <div data-v-e95a8a8c="" class="d-table-summary-item"
                                                        style="border: 2px solid {{ $color == '#ffffff' ? 'black' : $color }};">
                                                        <div data-v-e95a8a8c="" class="tu d-table-label">
                                                            {{ __('Total') }}:</div>
                                                        <div data-v-e95a8a8c="" class="d-table-value">
                                                            {{ $usr->priceFormat($estimation->getSubTotal() - $estimation->discount + $estimation->getTax()) }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
