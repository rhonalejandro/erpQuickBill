                                    ...
                                    <div data-v-4b3dcb8a="" class="d-table">
                                        <div data-v-4b3dcb8a="" class="d-table">
                                            <div data-v-4b3dcb8a="" class="tu d-table-tr"
                                                ...
                                                <div data-v-4b3dcb8a="" class="d-table-th w-13">
                                                    {{ __('Item description') }}</div>
                                                <div data-v-4b3dcb8a="" class="d-table-th w-3">{{ __('Price') }}
                                                </div>
                                                <div data-v-4b3dcb8a="" class="d-table-th w-2">{{ __('Qty') }}
                                                </div>
                                                <div data-v-4b3dcb8a="" class="d-table-th w-3 text-end">
                                                    {{ __('Amount') }}</div>
                                            </div>
                                                ...
                                                @if (isset($estimation->getProducts) && count($estimation->getProducts) > 0)
                                                    @foreach ($estimation->getProducts as $key => $item)
                                                        <div data-v-4b3dcb8a="" class="d-table-tr"
                                                            ...
                                                            <div data-v-4b3dcb8a="" class="d-table-td w-2">
                                                                <span>{{ $key + 1 }}</span></div>
                                                            <div data-v-4b3dcb8a="" class="d-table-td w-13">
                                                                <pre data-v-4b3dcb8a="">{{ $item->name }}<br data-v-4b3dcb8a=""></pre>
                                                            </div>
                                                            <div data-v-4b3dcb8a="" class="d-table-td w-3"><span
                                                                    data-v-4b3dcb8a="">{{ $usr->priceFormat($item->pivot->price) }}</span>
                                                            </div>
                                                            <div data-v-4b3dcb8a="" class="d-table-td w-2"><span
                                                                    data-v-4b3dcb8a="">{{ $item->pivot->quantity }}</span>
                                                            </div>
                                                            <div data-v-4b3dcb8a="" class="d-table-td w-3 text-end">
                                                                <span
                                                                    data-v-4b3dcb8a="">{{ $usr->priceFormat($item->pivot->price * $item->pivot->quantity) }}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
                                                    <div data-v-4b3dcb8a="" class="d-table-tr"
                                                        ...
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-2"><span
                                                                data-v-4b3dcb8a="">-</span></div>
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-3 text-end"><span
                                                                data-v-4b3dcb8a="">-</span></div>
                                                    </div>
                                                @endif
                                            </div>
                                                ...
                                                <div data-v-4b3dcb8a="" class="d-table-summary">
                                                    ...
                                                    <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-4b3dcb8a="" class="d-table-value"><strong
                                                                data-v-4b3dcb8a="">{{ $usr->priceFormat($estimation->getSubTotal() - $estimation->discount + $estimation->getTax()) }}</strong>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
