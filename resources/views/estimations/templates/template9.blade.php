                                        ...
                                        <div data-v-7d9d14b5="" class="d-table">
                                            <div data-v-7d9d14b5="" class="tu d-table-tr"
                                                ...
                                                <div data-v-7d9d14b5="" class="d-table-th w-2" style="padding: 3px;">
                                                    {{ __('#') }}</div>
                                                <div data-v-7d9d14b5="" class="d-table-th w-13" style="padding: 3px;">
                                                    {{ __('Item description') }}</div>
                                                <div data-v-7d9d14b5="" class="d-table-th w-3" style="padding: 3px;">
                                                    {{ __('Price') }}</div>
                                                <div data-v-7d9d14b5="" class="d-table-th w-2" style="padding: 3px;">
                                                    {{ __('Qty') }}</div>
                                                <div data-v-7d9d14b5="" class="d-table-th w-3 text-end"
                                                    style="padding: 3px;">{{ __('Amount') }}</div>
                                            </div>
                                                        ...
                                                        <div data-v-7d9d14b5="" class="d-table-tr"
                                                            ...
                                                            <div data-v-7d9d14b5="" class="d-table-td w-2"
                                                                style="padding: 3px;"><span
                                                                    data-v-7d9d14b5="">{{ $key + 1 }}</span>
                                                            </div>
                                                            <div data-v-7d9d14b5="" class="d-table-td w-13"
                                                                style="padding: 3px;">
                                                                <pre data-v-7d9d14b5="">{{ $item->name }}<br data-v-7d9d14b5=""></pre>
                                                            </div>
                                                            <div data-v-7d9d14b5="" class="d-table-td w-3"
                                                                style="padding: 3px;"><span
                                                                    data-v-7d9d14b5="">{{ $usr->priceFormat($item->pivot->price) }}</span>
                                                            </div>
                                                            <div data-v-7d9d14b5="" class="d-table-td w-2"
                                                                style="padding: 3px;"><span
                                                                    data-v-7d9d14b5="">{{ $item->pivot->quantity }}</span>
                                                            </div>
                                                            <div data-v-7d9d14b5="" class="d-table-td w-3 text-end"
                                                                style="padding: 3px;"><span
                                                                    data-v-7d9d14b5="">{{ $usr->priceFormat($item->pivot->price * $item->pivot->quantity) }}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
                                                    <div data-v-7d9d14b5="" class="d-table-tr"
                                                        style="border-bottom: 1px solid rgb(248, 248, 248);">
                                                        <div data-v-7d9d14b5="" class="d-table-td w-2"
                                                            style="padding: 3px;"><span data-v-7d9d14b5="">-</span>
                                                        </div>
                                                        <div data-v-7d9d14b5="" class="d-table-td w-13"
                                                            style="padding: 3px;">
