                                    ...
                                    <div data-v-e23d9750="" class="d-table">
                                        <div data-v-e23d9750="" class="d-table">
                                            <div data-v-e23d9750="" class="tu d-table-tr"
                                                ...
                                                <div data-v-e23d9750="" class="d-table-th w-13">
                                                    {{ __('Item description') }}</div>
                                                <div data-v-e23d9750="" class="d-table-th w-3">{{ __('Price') }}
                                                </div>
                                                <div data-v-e23d9750="" class="d-table-th w-2">{{ __('Qty') }}
                                                </div>
                                                <div data-v-e23d9750="" class="d-table-th w-3 text-end">
                                                    {{ __('Amount') }}</div>
                                            </div>
                                                ...
                                                @if (isset($estimation->getProducts) && count($estimation->getProducts) > 0)
                                                    @foreach ($estimation->getProducts as $key => $item)
                                                        <div data-v-e23d9750="" class="d-table-tr">
                                                            ...
                                                            <div data-v-e23d9750="" class="d-table-td w-3"><span
                                                                    data-v-e23d9750="">{{ $usr->priceFormat($item->pivot->price) }}</span>
                                                            </div>
                                                            <div data-v-e23d9750="" class="d-table-td w-2"><span
                                                                    data-v-e23d9750="">{{ $item->pivot->quantity }}</span>
                                                            </div>
                                                            <div data-v-e23d9750="" class="d-table-td w-3 text-end">
                                                                <span
                                                                    data-v-e23d9750="">{{ $usr->priceFormat($item->pivot->price * $item->pivot->quantity) }}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
                                                    <div data-v-e23d9750="" class="d-table-tr">
                                                        ...
                                                        <div data-v-e23d9750="" class="d-table-td w-2"><span
                                                                data-v-e23d9750="">-</span></div>
                                                        <div data-v-e23d9750="" class="d-table-td w-3 text-end"><span
                                                                data-v-e23d9750="">-</span></div>
                                                    </div>
                                                @endif
                                            </div>
