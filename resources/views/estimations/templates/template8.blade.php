                                            ...
                                            <table data-v-136bf9b5="" class="summary-table">
                                                <tbody data-v-136bf9b5="">
                                                    <tr data-v-136bf9b5="">
                                                        ...
                                                        <td data-v-136bf9b5="" class="text-end">
                                    ...
                                    <div data-v-136bf9b5="" class="d-table">
                                        <div data-v-136bf9b5="" class="d-table">
                                            <div data-v-136bf9b5="" class="d-table-tr">
                                                ...
                                                <div data-v-136bf9b5="" class="d-table-th w-13">
                                                    {{ __('Item description') }}</div>
                                                <div data-v-136bf9b5="" class="d-table-th w-3">{{ __('Price') }}
                                                </div>
                                                <div data-v-136bf9b5="" class="d-table-th w-2">{{ __('Qty') }}
                                                </div>
                                                <div data-v-136bf9b5="" class="d-table-th w-3 text-end">
                                                    {{ __('Amount') }}</div>
                                            </div>
                                            <div data-v-136bf9b5="" class="d-table-body">
                                                @if (isset($estimation->getProducts) && count($estimation->getProducts) > 0)
                                                    @foreach ($estimation->getProducts as $key => $item)
                                                        <div data-v-136bf9b5="" class="d-table-tr">
                                                            <div data-v-136bf9b5="" class="d-table-td w-2"><span
                                                                    data-v-136bf9b5="">{{ $key + 1 }}</span>
                                                            </div>
                                                            <div data-v-136bf9b5="" class="d-table-td w-13">
                                                                <pre data-v-136bf9b5="">{{ $item->name }}<br data-v-136bf9b5=""></pre>
                                                            </div>
                                                            <div data-v-136bf9b5="" class="d-table-td w-3"><span
                                                                    data-v-136bf9b5="">{{ $usr->priceFormat($item->pivot->price) }}</span>
                                                            </div>
                                                            <div data-v-136bf9b5="" class="d-table-td w-2"><span
                                                                    data-v-136bf9b5="">{{ $item->pivot->quantity }}</span>
                                                            </div>
                                                            <div data-v-136bf9b5="" class="d-table-td w-3 text-end">
                                                                <span
                                                                    data-v-136bf9b5="">{{ $usr->priceFormat($item->pivot->price * $item->pivot->quantity) }}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
                                                    <div data-v-136bf9b5="" class="d-table-tr">
                                                        ...
                                                        <div data-v-136bf9b5="" class="d-table-td w-2"><span
                                                                data-v-136bf9b5="">-</span></div>
                                                        <div data-v-136bf9b5="" class="d-table-td w-3 text-end"><span
                                                                data-v-136bf9b5="">-</span></div>
                                                    </div>
                                                @endif
                                            </div>
