                                ...
                                <div data-v-1ad6e3b9="" class="d-inner d-no-pad"
                                    ...
                                    <div data-v-1ad6e3b9="" class="row grey-box">
                                        <div data-v-1ad6e3b9="" class="col-33"><img data-v-1ad6e3b9=""
                                                src="{{ $img }}" class="d-logo" style="max-width: 200px;"> <br
                                            ...
                                            <div data-v-1ad6e3b9="" class="col-2">
                                                <div data-v-1ad6e3b9="" class="col-66">
                                                    ...
                                                    <strong data-v-1ad6e3b9=""
                                                        class="sub-title">{{ $client->name }}</strong>
                                        ...
                                        <div data-v-1ad6e3b9="" class="d-table">
                                            <div data-v-1ad6e3b9="" class="d-table">
                                                <div data-v-1ad6e3b9="" class="tu d-table-tr"
                                                    ...
                                                    <div data-v-1ad6e3b9="" class="d-table-th w-3"
                                                        style="padding: 5px;">{{ __('#') }}</div>
                                                    <div data-v-1ad6e3b9="" class="d-table-th w-13"
                                                        style="padding: 5px;">{{ __('Item description') }}</div>
                                                    <div data-v-1ad6e3b9="" class="d-table-th w-3"
                                                        style="padding: 5px;">{{ __('Price') }}</div>
                                                    <div data-v-1ad6e3b9="" class="d-table-th w-2"
                                                        style="padding: 5px;">{{ __('Qty') }}</div>
                                                    <div data-v-1ad6e3b9="" class="d-table-th w-3 text-end"
                                                        style="padding: 5px;">{{ __('Amount') }}</div>
                                                </div>
                                                    ...
                                                    @if (isset($estimation->getProducts) && count($estimation->getProducts) > 0)
                                                        @foreach ($estimation->getProducts as $key => $item)
                                                            <div data-v-1ad6e3b9="" class="d-table-tr">
                                                                <div data-v-1ad6e3b9="" class="d-table-td w-3"
                                                                    style="border: 1px solid {{ $color }}; padding: 5px;">
                                                                    <span
                                                                        data-v-1ad6e3b9="">{{ $key + 1 }}</span>
                                                                </div>
                                                                <div data-v-1ad6e3b9="" class="d-table-td w-13"
                                                                    style="border: 1px solid {{ $color }}; padding: 5px;">
                                                                ...
                                                                <div data-v-1ad6e3b9="" class="d-table-td w-3"
                                                                    style="border: 1px solid {{ $color }}; padding: 5px;">
                                                                    <span
                                                                        data-v-1ad6e3b9="">{{ $usr->priceFormat($item->pivot->price) }}</span>
                                                                </div>
                                                                <div data-v-1ad6e3b9="" class="d-table-td w-2"
                                                                    style="border: 1px solid {{ $color }}; padding: 5px;">
                                                                    <span
                                                                        data-v-1ad6e3b9="">{{ $item->pivot->quantity }}</span>
                                                                </div>
                                                                <div data-v-1ad6e3b9=""
                                                                    class="d-table-td w-3 text-end"
                                                                    style="border: 1px solid {{ $color }}; padding: 5px;">
                                                                    <span
                                                                        data-v-1ad6e3b9="">{{ $usr->priceFormat($item->pivot->price * $item->pivot->quantity) }}</span>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                    @else
                                                        <div data-v-1ad6e3b9="" class="d-table-tr">
                                                            ...
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-2"
                                                                style="border: 1px solid {{ $color }}; padding: 5px;">
                                                                <span data-v-1ad6e3b9="">-</span></div>
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-3 text-end"
                                                                style="border: 1px solid {{ $color }}; padding: 5px;">
                                                                <span data-v-1ad6e3b9="">-</span></div>
                                                        </div>
                                                    @endif
                                                    ...
                                                    <div data-v-1ad6e3b9="" class="d-table-summary">
                                                        <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                            ...
                                                            <div data-v-1ad6e3b9="" class="d-table-value">
                                                                {{ $usr->priceFormat($estimation->getSubTotal()) }}
                                                            </div>
                                                        </div>
                                                        @if ($estimation->discount)
                                                            <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                                <div data-v-1ad6e3b9="" class="tu d-table-label">
                                                                    {{ __('Discount') }}:</div>
                                                                <div data-v-1ad6e3b9="" class="d-table-value">
                                                                    {{ $usr->priceFormat($estimation->discount) }}
                                                                </div>
                                                            </div>
                                                        @endif
                                                        @if ($estimation->getTax())
                                                            <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                                ...
                                                                <div data-v-1ad6e3b9="" class="d-table-value">
                                                                    {{ $usr->priceFormat($estimation->getTax()) }}
                                                                </div>
                                                            </div>
                                                        @endif
                                                        <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                            ...
                                                            <div data-v-1ad6e3b9="" class="d-table-value"><strong
                                                                    data-v-1ad6e3b9="">{{ $usr->priceFormat($estimation->getSubTotal() - $estimation->discount + $estimation->getTax()) }}</strong>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
