                                ...
                                <div data-v-b8f60a0c="" class="d-inner">
                                    <div data-v-b8f60a0c="" class="row">
                                        ...
                                        <div data-v-b8f60a0c="" class="col-33"><img data-v-b8f60a0c=""
                                                style="max-width: 200px;" class="d-logo" src="{{ $img }}">
                                        </div>
                                    </div>
                                                ...
                                                <tbody data-v-b8f60a0c="">
                                                    <tr data-v-b8f60a0c="">
                                                        <td data-v-b8f60a0c="" class="tu fwb"
                                                            ...
                                                            {{ __('Number') }}:</td>
                                                        <td data-v-b8f60a0c="" class="text-end">
                                    ...
                                    <div data-v-b8f60a0c="" class="d-table">
                                        <div data-v-b8f60a0c="" class="d-table">
                                            <div data-v-b8f60a0c="" class="tu d-table-tr"
                                                ...
                                                <div data-v-b8f60a0c="" class="d-table-th w-13">
                                                    {{ __('Item description') }}</div>
                                                <div data-v-b8f60a0c="" class="d-table-th w-3">{{ __('Price') }}
                                                </div>
                                                <div data-v-b8f60a0c="" class="d-table-th w-2">{{ __('Qty') }}
                                                </div>
                                                <div data-v-b8f60a0c="" class="d-table-th w-3 text-end">
                                                    {{ __('Amount') }}</div>
                                            </div>
                                                ...
                                                @if (isset($estimation->getProducts) && count($estimation->getProducts) > 0)
                                                    @foreach ($estimation->getProducts as $key => $item)
                                                        <div data-v-b8f60a0c="" class="d-table-tr"
                                                            ...
                                                            <div data-v-b8f60a0c="" class="d-table-td w-2"><span
                                                                    data-v-b8f60a0c="">{{ $key + 1 }}</span>
                                                            </div>
                                                            <div data-v-b8f60a0c="" class="d-table-td w-13">
                                                                <pre data-v-b8f60a0c="">{{ $item->name }}<br data-v-b8f60a0c=""></pre>
                                                            </div>
                                                            <div data-v-b8f60a0c="" class="d-table-td w-3"><span
                                                                    data-v-b8f60a0c="">{{ $usr->priceFormat($item->pivot->price) }}</span>
                                                            </div>
                                                            <div data-v-b8f60a0c="" class="d-table-td w-2"><span
                                                                    data-v-b8f60a0c="">{{ $item->pivot->quantity }}</span>
                                                            </div>
                                                            <div data-v-b8f60a0c="" class="d-table-td w-3 text-end">
                                                                <span
                                                                    data-v-b8f60a0c="">{{ $usr->priceFormat($item->pivot->price * $item->pivot->quantity) }}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
                                                    <div data-v-b8f60a0c="" class="d-table-tr"
                                                        ...
                                                        <div data-v-b8f60a0c="" class="d-table-td w-2"><span
                                                                data-v-b8f60a0c="">-</span></div>
                                                        <div data-v-b8f60a0c="" class="d-table-td w-3 text-end"><span
                                                                data-v-b8f60a0c="">-</span></div>
                                                    </div>
                                                @endif
                                            </div>
