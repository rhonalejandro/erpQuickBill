...
@endif
                                        ...
                                        <div data-v-363339a0="" class="col-1">
                                            <img data-v-363339a0="" src="{{ $img }}" style="max-width: 150px"
                                                class="d-logo">
                                        </div>
                                    </div>
                                    ...
                                    <div data-v-363339a0="" class="d-table">
                                        <div data-v-363339a0="" class="d-table">
                                            <div data-v-363339a0="" class="tu d-table-tr"
                                                ...
                                                <div data-v-363339a0="" class="d-table-th w-13">
                                                    {{ __('Item description') }}</div>
                                                <div data-v-363339a0="" class="d-table-th w-3">{{ __('Price') }}
                                                </div>
                                                <div data-v-363339a0="" class="d-table-th w-2">{{ __('Qty') }}
                                                </div>
                                                <div data-v-363339a0="" class="d-table-th w-3 text-end">
                                                    {{ __('Amount') }}</div>
                                            </div>
                                                ...
                                                @if (isset($estimation->getProducts) && count($estimation->getProducts) > 0)
                                                    @foreach ($estimation->getProducts as $key => $item)
                                                        <div data-v-363339a0="" class="d-table-tr">
                                                            ...
                                                            <div data-v-363339a0="" class="d-table-td w-3"><span
                                                                    data-v-363339a0="">{{ $usr->priceFormat($item->pivot->price) }}</span>
                                                            </div>
                                                            <div data-v-363339a0="" class="d-table-td w-2"><span
                                                                    data-v-363339a0="">{{ $item->pivot->quantity }}</span>
                                                            </div>
                                                            <div data-v-363339a0="" class="d-table-td w-3 text-end">
                                                                <span
                                                                    data-v-363339a0="">{{ $usr->priceFormat($item->pivot->price * $item->pivot->quantity) }}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
                                                    <div data-v-363339a0="" class="d-table-tr">
                                                        ...
                                                        <div data-v-363339a0="" class="d-table-td w-2"><span
                                                                data-v-363339a0="">-</span></div>
                                                        <div data-v-363339a0="" class="d-table-td w-3 text-end"><span
                                                                data-v-363339a0="">-</span></div>
                                                    </div>
                                                @endif
                                            </div>
