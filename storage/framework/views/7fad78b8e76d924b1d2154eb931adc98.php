                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-md-6 ">
                                    <div class = "border border-2 p-3">
                                        <h4><?php echo e(__('Refer ') . $companyName .  __(' and earn ') . $currency . (isset($setting) ? $setting->minimum_threshold_amount : '') . __(' per paid signup!')); ?></h4>
                                ...
                                <?php if(isset($setting) && $setting->is_enable == 0 || !isset($setting)): ?>
                                        ...
                                        <?php if(\Auth::user()->commission_amount > $paidAmount): ?>
                                            ...
                                            <?php else: ?>
                                                <a href="<?php echo e(route('request.amount.cancel', \Auth::user()->id)); ?>"
                                                    class="btn btn-danger btn-sm" data-title="<?php echo e(__('Cancle Request')); ?>"
                                        ...
                                        <div class="border border-2 p-3">
                                            <div class="row align-items-center justify-content-between">
                                                ...
                                                <div class="col-auto text-end">
                                                    <h4 class="m-0"><?php echo e($currency . \Auth::user()->commission_amount); ?>
                                    ...
                                    <div class="col-lg-6 col-md-12 dashboard-card">
                                        <div class="border border-2 p-3">
                                            <div class="row align-items-center justify-content-between">
                                                ...
                                                <div class="col-auto text-end">
                                                    <h4 class="m-0"><?php echo e($currency . $paidAmount); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body table-border-style">
                                <div class="table-responsive">
                                    <table class="table datatable">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $transactionsOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e(++$key); ?></td>
                                                    ...
                                                    <td>
                                                        <?php if($transaction->status == 0): ?>
                                                            <span
                                                                class="status_badge badge bg-danger p-2 px-3 rounded"><?php echo e(__(\App\Models\TransactionOrder::$status[$transaction->status])); ?></span>
                                                        <?php elseif($transaction->status == 1): ?>
                                                            <span
                                                                class="status_badge badge bg-warning p-2 px-3 rounded"><?php echo e(__(\App\Models\TransactionOrder::$status[$transaction->status])); ?></span>
                                                        <?php elseif($transaction->status == 2): ?>
                                                            <span
                                                                class="status_badge badge bg-primary p-2 px-3 rounded"><?php echo e(__(\App\Models\TransactionOrder::$status[$transaction->status])); ?></span>
                                                        <?php endif; ?>
                                                    </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wwwLaragon\erpQuickBill\resources\views/referral-program/company.blade.php ENDPATH**/ ?>