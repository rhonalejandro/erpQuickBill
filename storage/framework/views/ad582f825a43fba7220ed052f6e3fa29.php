                ...
                <div class="card-body job-create ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <?php echo Form::text('title', old('title'), ['class' => 'form-control','required' => 'required' , 'placeholder'=>__('Enter Job Title')]); ?>
                ...
                <div class="card-body">
                    <div class="row ">
                        <div class="form-group col-6 mb-2">
                            <?php echo Form::label('requirement', __('Job Requirement'),['class'=>'form-label' , 'placeholder'=>__('Enter Job Requirement'),'required' => 'required' ]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wwwLaragon\erpQuickBill\resources\views/job/create.blade.php ENDPATH**/ ?>