...
<body class="<?php echo e($themeColor); ?>">
    <div class="custom-login">
        <div class="login-bg-img">
            <img src="<?php echo e(isset($setting['color_flag']) && $setting['color_flag'] == 'false' ? asset('assets/images/auth/' . $color . '.svg') : asset('assets/images/auth/theme-3.svg')); ?>"
                class="login-bg-1">
        ...
        <div class="custom-login-inner">
            ...
            <main style="z-index: 1;backgraund:#d2d2d2;">
...
<?php /**PATH D:\wwwLaragon\erpQuickBill\resources\views/layouts/register.blade.php ENDPATH**/ ?>