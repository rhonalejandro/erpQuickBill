                    ...
                    <div class="sticky-top" style="top:30px">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled my-5 mt-3">
                                        <li>
                                            ...
                                            <?php echo e($plan->max_users == -1 ? __('Unlimited') : $plan->max_users); ?>
                                        ...
                                        <li>
                                            <span class="theme-avtar"><i class="text-primary ti ti-circle-plus"></i></span>
                                            <?php echo e($plan->max_venders == -1 ? __('Unlimited') : $plan->max_venders); ?>
                        ...
                        <div class="card ">
                            <div class="list-group list-group-flush" id="useradd-sidenav">
                                ...
                                <?php endif; ?>
                                <?php if(isset($admin_payment_setting['tap_payment_is_on']) && $admin_payment_setting['tap_payment_is_on'] == 'on'): ?>
                                <a href="#tap_payment"
                                ...
                                <?php endif; ?>
                                <?php if(isset($admin_payment_setting['authorizenet_payment_is_on']) && $admin_payment_setting['authorizenet_payment_is_on'] == 'on'): ?>
                ...
                <div class="col-xl-9">
                    ...
                    <?php if($admin_payment_setting['is_manually_payment_enabled'] == 'on'): ?>
                        <div id="send_request" class="card">
                            ...
                            <div class="tab-pane <?php echo e(($admin_payment_setting['is_manually_payment_enabled'] == 'on') == 'on' ? 'active' : ''); ?>"
                                id="send_request">
                    ...
                    <?php if($admin_payment_setting['is_bank_transfer_enabled'] == 'on' && !empty($admin_payment_setting['bank_details'])): ?>
                        <div id="bank_payment" class="card">
                            ...
                            <div class="tab-pane <?php echo e(($admin_payment_setting['is_bank_transfer_enabled'] == 'on' && !empty($admin_payment_setting['bank_details'])) == 'on' ? 'active' : ''); ?>"
                                id="bank_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.bank')); ?>" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="custom-radio">
                                                    ...
                                                    <span
                                                        class="final-price"><?php echo e(isset($admin_payment_setting['currency_symbol']) ? $admin_payment_setting['currency_symbol'] : '$'); ?><?php echo e($plan->price); ?></span>
                                                </div>
                                        ...
                                        <div class="col-sm-12 my-2 px-2">
                                            <div class="text-end">
                                                <input type="button" id="pay_with_paystack"
                                                    value="<?php echo e(__('Pay Now')); ?>" class="btn btn-primary mb-2 me-3">
                                            </div>
                                        </div>
                    ...
                    <?php if(isset($admin_payment_setting['is_flutterwave_enabled']) && $admin_payment_setting['is_flutterwave_enabled'] == 'on'): ?>
                        <div id="flutterwave_payment" class="card">
                            ...
                            <div class="tab-pane " id="flutterwave_payment">
                                <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                    id="flaterwave-payment-form" action="<?php echo e(route('plan.pay.with.flaterwave')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="plan_id"
                                        value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($plan->id)); ?>">
                    ...
                    <?php if(isset($admin_payment_setting['is_razorpay_enabled']) && $admin_payment_setting['is_razorpay_enabled'] == 'on'): ?>
                        <div id="razorpay_payment" class="card">
                            ...
                            <div class="tab-pane " id="razorpay_payment">
                                <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                    id="razorpay-payment-form" action="<?php echo e(route('plan.pay.with.razorpay')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="plan_id"
                                        value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($plan->id)); ?>">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="mobile_number"
                                                        class="form-label"><?php echo e(__('Mobile Number')); ?></label>
                    ...
                    <?php if(isset($admin_payment_setting['is_yookassa_enabled']) && $admin_payment_setting['is_yookassa_enabled'] == 'on'): ?>
                        <div id="yookassa_payment" class="card">
                            ...
                            <div class="tab-pane" id="yookassa_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.yookassa', $plan->id)); ?>"
                    ...
                    <?php if(isset($admin_payment_setting['is_midtrans_enabled']) && $admin_payment_setting['is_midtrans_enabled'] == 'on'): ?>
                        <div id="midtrans_payment" class="card">
                            ...
                            <div class="tab-pane" id="midtrans_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.midtrans', $plan->id)); ?>"
                    ...
                    <?php if(isset($admin_payment_setting['is_xendit_enabled']) && $admin_payment_setting['is_xendit_enabled'] == 'on'): ?>
                        <div id="xendit_payment" class="card">
                            ...
                            <div class="tab-pane" id="xendit_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.xendit', $plan->id)); ?>"
                    ...
                    <?php if(isset($admin_payment_setting['is_nepalste_enabled']) && $admin_payment_setting['is_nepalste_enabled'] == 'on'): ?>
                        <div id="nepalste_payment" class="card">
                            ...
                            <div class="tab-pane" id="nepalste_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.nepalste', $plan->id)); ?>"
                    ...
                    <?php if(isset($admin_payment_setting['is_paiementpro_enabled']) && $admin_payment_setting['is_paiementpro_enabled'] == 'on'): ?>
                        <div id="paiementpro_payment" class="card">
                            ...
                            <div class="tab-pane" id="paiementpro_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.paiementpro', $plan->id)); ?>"
                    ...
                    <?php if(isset($admin_payment_setting['is_cinetpay_enabled']) && $admin_payment_setting['is_cinetpay_enabled'] == 'on'): ?>
                        <div id="cinetpay_payment" class="card">
                            ...
                            <div class="tab-pane" id="cinetpay_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.cinetpay', $plan->id)); ?>"
                     ...
                     <?php if(isset($admin_payment_setting['is_fedapay_enabled']) && $admin_payment_setting['is_fedapay_enabled'] == 'on'): ?>
                        <div id="fedapay_payment" class="card">
                            ...
                            <div class="tab-pane" id="fedapay_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.fedapay', $plan->id)); ?>"
                     ...
                     <?php if(isset($admin_payment_setting['is_payhere_enabled']) && $admin_payment_setting['is_payhere_enabled'] == 'on'): ?>
                        <div id="payhere_payment" class="card">
                            ...
                            <div class="tab-pane" id="payhere_payment">
                                <form role="form" action="<?php echo e(route('plan.pay.with.payhere', $plan->id)); ?>"
                       ...
                       <?php if(isset($admin_payment_setting['tap_payment_is_on']) && $admin_payment_setting['tap_payment_is_on'] == 'on'): ?>
                            <div id="tap_payment" class="card">
                                ...
                                <div class="tab-pane" id="tap_payment">
                                    <form role="form" action="<?php echo e(route('plan.pay.with.tap', $plan->id)); ?>"
                        ...
                        <?php if(isset($admin_payment_setting['authorizenet_payment_is_on']) && $admin_payment_setting['authorizenet_payment_is_on'] == 'on'): ?>
                            <div id="authorizenet_payment" class="card">
                                ...
                                <div class="tab-pane" id="authorizenet_payment">
                                    <form role="form" action="<?php echo e(route('plan.pay.with.authorizenet', $plan->id)); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wwwLaragon\erpQuickBill\resources\views/stripe.blade.php ENDPATH**/ ?>