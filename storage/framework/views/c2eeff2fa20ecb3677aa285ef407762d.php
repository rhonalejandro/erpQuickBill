...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('place_of_visit',null,array('class'=>'form-control','required'=>'required' ,'placeholder'=>__('Enter Place of Visit')))); ?>
...
<?php /**PATH D:\wwwLaragon\erpQuickBill\resources\views/travel/create.blade.php ENDPATH**/ ?>