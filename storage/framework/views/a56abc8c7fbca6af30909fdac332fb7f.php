                        ...
                        <div class="row ">
                            <div class="col-6">
                                <ul class="list-unstyled my-5">
                                    ...
                                    <li class="white-sapce-nowrap"><span class="theme-avtar"><i
                                                class="text-primary ti ti-circle-plus"></i></span><?php echo e($plan->max_invoices == -1 ? __('Unlimited') : $plan->max_invoices); ?>

                                        <?php echo e(__('Invoices')); ?></li>
                                    <li class="white-sapce-nowrap"><span class="theme-avtar"><i
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wwwLaragon\erpQuickBill\resources\views/plan/index.blade.php ENDPATH**/ ?>