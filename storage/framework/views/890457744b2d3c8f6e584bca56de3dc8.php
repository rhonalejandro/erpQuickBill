...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6 col-lg-6">
            ...
            <?php echo e(Form::text('gift',null,array('class'=>'form-control','placeholder'=>__('Enter Gift'),'required'=>'required'))); ?>
...
<?php /**PATH D:\wwwLaragon\erpQuickBill\resources\views/award/create.blade.php ENDPATH**/ ?>