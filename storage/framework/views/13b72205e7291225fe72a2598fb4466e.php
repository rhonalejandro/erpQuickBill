    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::number('contact',null,array('class'=>'form-control','required'=>'required' , 'placeholder'=>__('Enter Contact')))); ?>
...
<?php /**PATH D:\wwwLaragon\erpQuickBill\resources\views/customer/create.blade.php ENDPATH**/ ?>