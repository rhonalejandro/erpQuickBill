    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('title',null,array('class'=>'form-control','placeholder'=>__('Enter Meeting Title'), 'required' => 'required'))); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::time('time',null,array('class'=>'form-control timepicker', 'required' => 'required'))); ?>
...
<?php /**PATH D:\wwwLaragon\erpQuickBill\resources\views/meeting/create.blade.php ENDPATH**/ ?>