...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::number('price', null, ['class' => 'form-control', 'placeholder' => __('Enter Plan Price'), 'required' => 'required', 'step' => '0.01'])); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::number('max_users', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Maximum Users')])); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::number('max_customers', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Maximum Customers')])); ?>

            <span class="small"><?php echo e(__('Note: "-1" for Unlimited')); ?></span>
        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('max_venders', __('Maximum Vendors'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::number('max_venders', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Maximum Vendors')])); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::number('max_clients', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Maximum Clients')])); ?>

            <span class="small"><?php echo e(__('Note: "-1" for Unlimited')); ?></span>
        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('max_invoices', __('Maximum Invoices'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::number('max_invoices', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Maximum Invoices')])); ?>
...
<?php /**PATH D:\wwwLaragon\erpQuickBill\resources\views/plan/create.blade.php ENDPATH**/ ?>